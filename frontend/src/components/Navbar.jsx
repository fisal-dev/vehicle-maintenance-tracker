    ...
    <>
      <motion.nav
        ...
        className={`
          ...
          ${scrolled
            ? "bg-[#080C14]/90 backdrop-blur-2xl border-b border-white/5 shadow-[0_1px_40px_rgba(0,0,0,0.4)]"
            : "bg-transparent"
          }
        `}
      >
        <div className="max-w-7xl mx-auto px-5 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/signup">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-500 border border-indigo-500/50 rounded-xl shadow-[0_0_20px_rgba(99,102,241,0.25)] hover:shadow-[0_0_28px_rgba(99,102,241,0.4)] transition-all duration-200"
              >
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden p-2 rounded-lg bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white transition-all"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 w-72 z-50 bg-[#0D1424]/95 backdrop-blur-2xl border-l border-white/5 flex flex-col md:hidden"
            >
